...
def get_task_regressors(trial_data, bwidth):
    ...
    rchoice.add_basis_function('gaussian_basis', 1, 1, n_funcs=12, sigma=S)
    lchoice = EventRegressor('left_choice', choice_time[l_choice].values, bwidth, tags='choice')
    lchoice.add_basis_function('gaussian_basis', 1, 1, n_funcs=12, sigma=S)
    ...
    reward.add_basis_function('gaussian_basis', 0, 2, n_funcs=10, sigma=S)
    punish = EventRegressor('punish', reward_time[punished].values, bwidth, tags='feedback')
    punish.add_basis_function('gaussian_basis', 0, 2, n_funcs=10, sigma=S)
    ...
    inter1.add_basis_function('gaussian_basis', 0, 2, n_funcs=10, sigma=S)
...
#         reg.add_basis_function('gaussian_basis', .5, .3, n_funcs=5,)
...
#     lickreg.add_basis_function('gaussian_basis', .3, .3, n_funcs=5,)
#     #lickreg.add_basis_function('raised_cosine', .3, 0, n_funcs=5, log_scale=True)
#     #lickreg.add_basis_function('raised_cosine', 0, .3, n_funcs=3, log_scale=True)
...
#     svd_regs = []
#     for label in LABELS:
#         #svd_path = Path(str(v).replace('raw.mp4','svd.npy'))
#         #me_svd_path = Path(str(v).replace('raw.mp4','motion_energy_svd.npy'))
...
#             svdreg.add_basis_function('gaussian_basis', .3, .2, n_funcs=10)
...
#             mereg.add_basis_function('gaussian_basis', .3, .2, n_funcs=10)
